...
const Animation = () => {
    ...
    return (
        <div className="asto-container">
            <svg version="1.1" className="rocketManSVG" xmlns="http://www.w3.org/2000/svg" style = {{ width: "100%", height: "100%"}}>
                ...
                C325,454.5,313.8,465.7,300,465.7z" />
                    ...
                    <symbol id="badge">
                        ...
                        <circle fill="#1668B2" stroke="#EF3D43" strokeWidth="1.4389" strokeMiterlimit="10" cx="319.6" cy="288.9" r="8.7" />
                        <g>
                            <g>
                ...
                <g className="satellite">
                    <g className="satellitePulses" stroke="#2d2d2d">
                        <path className="satellitePulse1" fill="none" strokeWidth="1.5814" strokeLinejoin="round" strokeMiterlimit="10" d="M156.3,131.8
            c-2.8,2.8-7.2,2.8-10,0" />
                        <path className="satellitePulse2" fill="none" strokeWidth="1.5814" strokeLinejoin="round" strokeMiterlimit="10" d="M158.6,134
            c-4,4-10.5,4-14.4,0" />
                        <path className="satellitePulse3" fill="none" strokeWidth="1.5814" strokeLinejoin="round" strokeMiterlimit="10" d="M160.8,136.3
        ...
        V117.8z" />
                ...
                <g className="astronaut">
                    ...
                    <g className="pulseSVG" opacity="0.2" stroke="#ededed">
                        <path className="pulse1" fill="none" strokeWidth="3" strokeLinejoin="round" strokeMiterlimit="10" d="M289.9,188.7
            c5.2-5.2,13.7-5.2,18.9,0" />
                        <path className="pulse2" fill="none" strokeWidth="3" strokeLinejoin="round" strokeMiterlimit="10" d="M285.6,184.5
            c7.6-7.6,19.8-7.6,27.4,0" />
                        <path className="pulse3" fill="none" strokeWidth="3" strokeLinejoin="round" strokeMiterlimit="10" d="M281.4,180.3
            c9.9-9.9,26-9.9,35.9,0" />
                ...
                c0,6.1,3.4,11.2,10.2,15.5c6.8,4.3,15.1,6.4,24.7,6.4C309.4,268,317.6,265.9,324.5,261.6z" />
                    ...
                    <path className="astronautglass" fill="none" stroke="#2D2D2D" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" d="M334.7,246.1
            ...
            c0-5.1,2.4-9.6,7.3-13.4h55.5C332.3,236.5,334.7,241,334.7,246.1z" />
                    ...
                    <path className="astronautglass" fill="none" stroke="#E6E6E6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" d="
            M323.5,240.6c2.4,3.5,2.4,7.8,0,12.7 M275.8,240.6c-2.4,3.5-2.4,7.8,0,12.7" />

                    <g className="jetBubbles">
                        <g id="greyJets" fill="#2d2d2d">

                            <circle className="jetBubble1" cx="289" cy="489" r="23" />
                            <circle className="jetBubble1" cx="270" cy="470" r="20" />
                            <circle className="jetBubble1" cx="319" cy="483" r="21" />
                        </g>
                        <g id="colorJets" strokeWidth="0" stroke="#3d3d3d">
                            <circle className="jetBubble2" fill="#ECB447" cx="312" cy="449" r="8" />
                            <circle className="jetBubble2" fill="#7D6AAD" cx="320" cy="480" r="10" />
                            <circle className="jetBubble2" fill="#7D6AAD" cx="290" cy="460" r="10" />
                            <circle className="jetBubble2" fill="#ECB447" cx="329" cy="453" r="11" />
                            <circle className="jetBubble" fill="#CC583F" cx="286" cy="463" r="7" />
                            <circle className="jetBubble2" fill="#ECB447" cx="289" cy="469" r="24" />
                            <circle className="jetBubble2" fill="#7D6AAD" cx="260" cy="450" r="20" />
                            <circle className="jetBubble3" fill="#5991AA" cx="319" cy="463" r="10" />
                            <circle className="jetBubble1" fill="#CC583F" cx="290" cy="463" r="18" />
                            <circle className="jetBubble3" fill="#75C095" cx="312" cy="443" r="21" />

                            <circle className="jetBubble3" fill="#5991AA" cx="275" cy="443.4" r="12" />
                        </g>
                        <g className="badge1">
